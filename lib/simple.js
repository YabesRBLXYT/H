...
const { default: _makeWaSocket, makeWALegacySocket, proto, downloadContentFromMessage, jidDecode, areJidsSameUser, generateForwardMessageContent, generateWAMessageFromContent, WAMessageStubType, extractMessageContent } = (await import('@whiskeysockets/baileys')).default
    ...
    let sock = Object.defineProperties(conn, {
        ...
        sendFile: {
            async value(jid, path, filename = '', caption = '', quoted, ptt = false, options = {}) {
                ...
                if (fileSize >= 20000) throw new Error(' ✳️  File size is too large\n\n')
                let opt = {}
...
/**
    ...
    */
    sendPoll: {
        ...
        Sumi: {
			async value(jid, title, text = '', thumbnailUrl, thumbnail, sourceUrl, quoted, LargerThumbnail = true, AdAttribution = true) {
